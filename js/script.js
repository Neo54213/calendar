...
document.getElementsByTagName("h1")[0].innerText += sMonthName[oMonthDate.getMonth()] + ' ' + oMonthDate.getFullYear();
document.getElementsByTagName("title")[0].innerText += sMonthName[oMonthDate.getMonth()] + ' ' + oMonthDate.getFullYear();
};